...
function nuevaReserva() {
    ...
    while (confirmacion) {
        ...
        let numeroContacto = parseInt(prompt("Ingrese el número de contacto"));
        let fecha = prompt("MILO RESTO\n\nIngrese la fecha (formato dd/mm/aaa)");
        let cantidadPersonas = prompt("MILO RESTO\n\nIngrese la cantidad de personas");
        let infante = confirm("MILO RESTO\n\nDentro de la cantidad de personas, hay niños que necesiten silla aparte?");
        if (infante) {
            let cantidadInfante = parseInt(prompt("MILO RESTO\n\nIngrese la cantidad de sillas de niños necesarias"));
            while (cantidadInfante > cantidadPersonas){
                cantidadInfante = parseInt(prompt("MILO RESTO\n\nLa cantidad de niños no puede ser mayor a la cantidad de personas ingresadas ("+cantidadPersonas+")\nIngrese la cantidad de sillas de niños necesarias"))
            }
            let nuevaReserva = new Reserva (nombre, numeroContacto, fecha, cantidadPersonas, cantidadInfante);
